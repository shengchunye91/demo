        ...
        (function($, undefined) {
            ...
            $.widget.bridge = function(name, object) {
                ...
                $.fn[name] = function(options) {
                    ...
                    options = !isMethodCall && args.length ? $.widget.extend.apply(null, [ options ].concat(args))
                            : options;
                    ...
                    if (isMethodCall) {
                        this.each(function() {
                            ...
                            if (methodValue !== instance && methodValue !== undefined) {
                                returnValue = methodValue && methodValue.jquery ? returnValue.pushStack(methodValue
                                        .get()) : methodValue;
                                return false;
                            }
                        });
